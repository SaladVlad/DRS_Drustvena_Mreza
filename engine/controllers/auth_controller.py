...
from .DAO.users_DAO import read_users,read_user, update_user
...
def check_if_blocked():
    ...
    if user is not None: return {"is_blocked": user["is_blocked"]}, 200
...
def login_user(**kwargs):
    ...
    if user.is_blocked:    
        return {"status":"FORBIDDEN","error": "User is blocked"}, 403
